...
<div class="row">
              <div class="col-13">
                <div class="card">
                  ...
                  <a href="#" type="button" class="btn btn-success" data-toggle="modal" data-target="#ModalCrearFicha">Crear Ficha</a><br/>
                  </div>
                  <h4>Fichas</h4>
                      ...
                      <table class="table table-striped" id="table-1">
                        <thead>
                          <tr>
                            ...
                            <th>Fecha Creación de la ficha</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @endif
                                <td><a href="#" type="button" class="btn btn-outline-success" data-toggle="modal" title="Editar" data-target="#ModalEditarFicha{{ $fichas->idFicha }}"><i class="fas fa-pencil-alt"></i></a></td>
                                <td><a href="#" type="button" class="btn btn-info" data-toggle="modal" data-target="#ModalAñadirAprendizFicha{{ $fichas->idFicha }}">AñadirAprendiz</a></td>
                                @endforeach
                            </tr>
                            @endif
                        </tbody>
